...
import { User as UserIcon, LogOut, LayoutDashboard, Package, Heart, ShieldCheck, LifeBuoy } from "lucide-react";
...
export function HeaderAuth() {
  ...
  if (status === "loading") {
    return <Button variant="ghost" size="icon" aria-label="Account" disabled>
  ...
  return <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="ml-0.5 grid h-9 w-9 place-items-center rounded-full ring-offset-background transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2" aria-label="Account menu">
