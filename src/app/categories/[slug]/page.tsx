...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      ...
      `Browse ${category.name} products at KBSCircuit.`,
  };
}
            ...
            <nav className="mt-3 flex flex-col gap-1">
              ...
              {otherCategories.map((c) => (
                <Link
                  ...
                  className="flex items-center justify-between rounded-md px-3 py-2 text-sm text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground"
                >
                  <span>{c.name}</span>
