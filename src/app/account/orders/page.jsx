...
export default async function OrdersPage() {
  ...
  return <div className="space-y-6">
      <header className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Track and review the orders you&apos;ve placed with LUMI Computer.
          </p>
        </div>
      ...
      {orders.length === 0 ? <Card className="p-0">
          ...
          <CardContent className="px-0">
            ...
            return <div key={o.id} className="rounded-lg border border-border p-3">
                    ...
                    <div className="mt-2 text-sm">
                      {firstItem ? <span className="line-clamp-1">
                          {firstItem.name}
                          {moreCount > 0 && <span className="text-muted-foreground"> +{moreCount} more</span>}
                        </span> : <span className="text-muted-foreground">No items</span>}
                    </div>
                  ...
                  return <TableRow key={o.id}>
                          ...
                          <TableCell className="max-w-xs">
                            <span className="line-clamp-1 text-sm">
                              {firstItem ? <>
                                  {firstItem.name}
                                  {moreCount > 0 && <span className="text-muted-foreground">
                                      {" "}
                                      +{moreCount} more
                                    </span>}
                                </> : <span className="text-muted-foreground">
