  ...
  function handleEdit() {
    ...
    toast.info("Edit (demo)", {
      description: itemName
        ? `An edit form for “${itemName}” would open here.`
        : "An edit form would open here.",
    });
  }
      ...
      action: {
        ...
        onClick: () =>
          toast.success("Deleted (demo)", {
            description: itemName
              ? `“${itemName}” would be removed.`
              : "The record would be removed.",
          }),
      },
  ...
  return (
    <div className="mt-3 flex items-center gap-2">
      ...
      <Button
        ...
        size="sm"
        onClick={handleEdit}
        className={viewHref ? "flex-1" : "flex-1"}
      >
