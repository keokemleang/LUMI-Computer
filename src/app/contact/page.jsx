...
import { Mail, Phone, MapPin, Clock, MessageSquare, LifeBuoy, Users, ArrowRight } from "lucide-react";
...
export const metadata = {
  title: "Contact",
  description: "Get in touch with the LUMI Computer team. We help with orders, compatibility questions, and partnerships."
};
const CONTACT_INFO = [{
  icon: Mail,
  label: "Email",
  ...
  return <div className="container-page py-8 md:py-10">
      ...
      <header className="mt-6 max-w-2xl space-y-3">
        ...
        <p className="text-muted-foreground">
          Questions about an order, a product, or compatibility? Fill out the form
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6 sm:p-8">
            ...
            <dl className="mt-4 grid gap-4 sm:grid-cols-2">
              {CONTACT_INFO.map(c => <div key={c.label} className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <dd className="mt-0.5 break-words text-sm font-medium text-foreground">
                      {c.href ? <a href={c.href} className="hover:text-primary hover:underline">
                          {c.value}
                        </a> : c.value}
                    </dd>
                  </div>
        ...
        <aside className="space-y-6 lg:sticky lg:top-20 lg:self-start">
          <Card className="p-6">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Many common questions about shipping, refunds, and compatibility
          ...
          <Card className="flex items-start gap-3 p-5">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                ...
                email{" "}
                <a href="mailto:hello@kbscircuit.com" className="font-medium text-primary hover:underline">
